...
from apps.gastos.views.proveedores import (
    listado_proveedores,
    crear_proveedor,
    editar_proveedor,
    registrar_proveedor_desde_factura,
    toggle_estado_proveedor,
    ver_proveedor,
)
app_name = "gastos"
...
urlpatterns = [
    ...
    path("proveedores/<int:proveedor_id>/toggle/", toggle_estado_proveedor, name="toggle_estado_proveedor"),

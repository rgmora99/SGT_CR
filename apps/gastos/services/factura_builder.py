...
def crear_factura_desde_correo(*, negocio, usuario, meta, factura_data, xml_bytes, xml_name, pdf_bytes, pdf_name):
    f = FacturaGasto.objects.create(
        ...
        moneda=factura_data.get("moneda", "CRC"),
        tipo_documento_xml=factura_data.get("tipo_documento_xml", "factura_electronica"),
        alerta_ingesta=factura_data.get("alerta_ingesta"),
        estado="pendiente",
        origen="correo",
